...
export const CreateTodolist = () => {
    ...
    const createTodolist = () => {
        todolistAPI.createTodolist(todolistTitle).then(response => setState(response.data))
...
export const UpdateTodolistTitle = () => {
    ...
    const updateTodolistTitle = () => {
        todolistAPI
            .updateTodolistTitle({ todolistId, title: todolistTitle })
...
export const CreateTask = () => {
    ...
    const createTask = () => {
        tasksAPI.createTask(todolistId, taskTitle).then(response => setState(response.data))
    ...
    return (
        <div>
            <input
                ...
                placeholder="Enter todolist ID"
            />
            <input value={taskTitle} onChange={onChangeTaskTitle} placeholder="Enter task title" />
...
export const DeleteTask = () => {
    ...
    const deleteTask = () => {
        tasksAPI.deleteTask({ todolistId, taskId }).then(response => setState(response.data))
    ...
    return (
        <div>
            <input
                ...
                placeholder="Enter todolist ID"
            />
            <input value={taskId} onChange={onChangeTaskIdHandler} placeholder="Enter task Id" />
...
export const UpdateTask = () => {
    ...
    const updateTask = () => {
        ...
        tasksAPI.updateTask({ todolistId, taskId, model }).then(response => setState(response.data))
